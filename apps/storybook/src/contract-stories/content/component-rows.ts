...
export const componentFamilyRows = [
  ...
  { family: "Work Management", components: "RelationshipChip, MachineToken, WorkManagementSubnav, WorkBoard, WorkHierarchy, GatePipeline, EvidenceAttachmentList, WorkItemInspector, SavedViewToolbar", scope: "Initiative/Epic/Story/Work Item hierarchy, board lanes, relationship vocabulary, gate pipeline, evidence attachments, saved views, and execution-record token containment", status: "Component library available for static/no-live Work Management surfaces; product adoption separate" },
