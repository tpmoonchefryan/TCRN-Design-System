...
export const componentFamilyRows = [
  ...
  { family: "Feedback and readiness", components: "Badge, Stamp, StampRule, InlineAlert, LiveRegion, Skeleton, StateSurface, EmptyState, ErrorState, EnvironmentBanner, GateReadinessPanel, EvidenceStrip, ReadbackPanel, StateView", scope: "Loading, blocked, unknown, empty, error, and proof-dependent states, and governed identity stamps for gate-close/ruling/release moments", status: "Component library available" },
