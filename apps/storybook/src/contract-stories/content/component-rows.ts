...
export const componentFamilyRows = [
  ...
  { family: "Layout and text", components: "Text, Heading, Highlight, Surface, Divider, FilterBar", scope: "Spacing floor, headings, inline highlighting, sections, dividers, and filter grouping", status: "Component library available" },
