...
export const componentFamilyRows = [
  ...
  { family: "Navigation", components: "TopBar, SideNav, NavGroup, NavItem, Breadcrumb, ModuleTabs, SectionTabs, SegmentedNav, ProductSwitcher, Pagination, SkipLink, SideNavCollapseButton, ShellThemeToggle, ShellLocaleMenu", scope: "Product orientation, side navigation, local section movement, compact shell controls, and skip access", status: "Component library available; full shells remain product-owned" },
