...
export const componentFamilyRows = [
  ...
  { family: "Data display", components: "TableShell, TableToolbar, WorkIndex, DetailInspector, StatusBadge, KeyValueList", scope: "Dense scanning, readable state, and empty/error distinction", status: "Component library available; DataGrid not included" },
  ...
  { family: "Knowledge Management", components: "KnowledgePageTree, KnowledgeDocumentCanvas, KnowledgeTocRail, KnowledgeInlineCommentList, KnowledgeMetadataRail, KnowledgeAttachmentList, KnowledgeLabelSet, KnowledgeVersionHistory, TemplateGallery, KnowledgeSearchResults", scope: "Static Knowledge Base page trees, document canvas, local table of contents, comments, metadata, attachments, labels, version history, templates, and local result lists", status: "Component library available for static/no-live Knowledge discussion surfaces; product adoption and backend publishing separate" },
  { family: "Feedback and readiness", components: "Badge, Stamp, StampRule, InlineAlert, LiveRegion, Skeleton, StateSurface, EmptyState, ErrorState, EnvironmentBanner, StatusSummaryPanel, EvidenceStrip, ReadbackPanel, StateView", scope: "Loading, blocked, unknown, empty, error, and proof-dependent states, and governed identity stamps for gate-close/ruling/release moments", status: "Component library available" },
