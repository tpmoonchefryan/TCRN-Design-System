export const patternExpansionRows = [
  ...
  { pattern: "Work Management", baseline: "Use package-backed WorkPageHeader, WorkViewTabs, WorkQuickFilters, WorkItemRow, WorkList, WorkSplitView, WorkBacklogGroup, WorkBoardView, WorkDetailLayout, MetadataRail, WorkFieldPanel, WorkActivityFeed, RelationshipChip, GatePipelineCompact, EvidenceAttachmentList, WorkItemInspector, SavedViewToolbar, MachineToken, and MachineTokenCell for static Work module discussion surfaces", escalation: "API-backed mutation, live dispatch, persisted saved views, and product adoption require downstream product routes" }
];
