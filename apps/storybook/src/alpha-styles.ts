...
.tcrn-doc-shell {
  ...
  transition: --tcrn-doc-shell-side-width var(--tcrn-motion-emphasis);
}
...
.tcrn-doc-global-bar {
  display: grid;
  grid-template-columns: var(--tcrn-doc-shell-side-width) minmax(320px, 1fr) minmax(320px, 420px);
  align-items: center;
  gap: 0;
  min-width: 0;
  min-height: var(--tcrn-anchor-scroll-offset);
...
.tcrn-doc-header__workspace {
  ...
  min-width: 0;
  padding: 12px clamp(20px, 2.2vw, 36px) 12px clamp(28px, 2.8vw, 48px);
  border-left: 0;
}
...
.tcrn-doc-search-results {
  ...
  background: var(--tcrn-color-surface-panel);
  box-shadow: var(--tcrn-shadow-soft);
  padding: 6px;
}
...
.tcrn-doc-search-results__empty {
  border-radius: var(--tcrn-radius-control);
  padding: 8px 10px;
}
.tcrn-doc-search-result {
...
.tcrn-doc-search-result[aria-selected="true"],
.tcrn-doc-search-result:hover {
  background: var(--tcrn-color-brand-primary-bg);
}
.tcrn-doc-search-result:focus-visible {
  outline: 2px solid var(--tcrn-color-focus-ring);
  outline-offset: 2px;
}
.tcrn-doc-search-result__title {
  font-size: 13px;
  font-weight: 700;
  line-height: 1.25;
}
.tcrn-doc-search-result__meta,
.tcrn-doc-search-results__empty {
  color: var(--tcrn-color-text-secondary);
  font-size: 12px;
  font-weight: 600;
...
.tcrn-doc-header-controls {
  ...
  background: transparent;
  color: var(--tcrn-color-text-primary);
  padding: 12px clamp(18px, 2vw, 30px) 12px 12px;
}
.tcrn-doc-header-controls__row {
  display: grid;
  grid-template-columns: minmax(112px, 0.75fr) minmax(150px, 1fr) 36px;
  gap: 8px;
  align-items: end;
  min-width: 0;
}
.tcrn-doc-theme-control,
.tcrn-doc-locale-control {
  display: grid;
  gap: 4px;
  min-width: 0;
  font-size: 11px;
...
.tcrn-doc-theme-control__label,
.tcrn-doc-locale-control__label {
  display: block;
  overflow: hidden;
  color: var(--tcrn-color-text-secondary);
  font-size: 10px;
...
.tcrn-doc-theme-control__buttons {
  display: inline-grid;
  ...
  border: 1px solid var(--tcrn-color-border-strong);
  border-radius: 999px;
  background: color-mix(in srgb, var(--tcrn-color-surface-panel) 82%, var(--tcrn-color-surface-muted));
  padding: 2px;
}
.tcrn-doc-theme-control__button {
  display: inline-flex;
  align-items: center;
  ...
  white-space: nowrap;
  transition:
    background var(--tcrn-motion-standard),
    box-shadow var(--tcrn-motion-standard),
    color var(--tcrn-motion-standard);
}
.tcrn-doc-theme-control__button[aria-pressed="true"] {
  background: color-mix(in srgb, var(--tcrn-color-surface-panel) 86%, var(--tcrn-color-text-primary) 8%);
  color: var(--tcrn-color-text-primary);
...
.tcrn-doc-ai-contract-link:hover {
...
.tcrn-doc-ai-contract-link:focus-visible,
.tcrn-doc-theme-control__button:focus-visible,
.tcrn-doc-locale-control select:focus-visible {
  outline: 2px solid var(--tcrn-color-focus-ring);
  outline-offset: 2px;
}
.tcrn-doc-ai-contract-link__icon {
  width: 14px;
  height: 14px;
  color: var(--tcrn-color-text-secondary);
}
.tcrn-doc-locale-control__select {
  position: relative;
  display: block;
  min-width: 0;
}
.tcrn-doc-locale-control select {
  width: 100%;
  min-height: 34px;
  appearance: none;
  border: 1px solid var(--tcrn-color-border-strong);
...
.tcrn-doc-header-controls__hint {
  margin: 0;
  overflow: hidden;
  color: var(--tcrn-color-text-secondary);
  font-size: 10px;
...
.tcrn-doc-sidebar-toggle__icon-svg {
  width: 16px;
  height: 16px;
  display: none !important;
  transition:
    opacity var(--tcrn-motion-standard),
    transform var(--tcrn-motion-standard);
}
.tcrn-doc-sidebar-toggle__icon-svg--close {
  display: block !important;
}
.tcrn-doc-sidebar-toggle__icon-svg--open {
  display: none !important;
}
.tcrn-doc-shell[data-sidebar-collapsed="true"] .tcrn-doc-sidebar-toggle__icon-svg--close {
  display: none !important;
}
.tcrn-doc-shell[data-sidebar-collapsed="true"] .tcrn-doc-sidebar-toggle__icon-svg--open {
  display: block !important;
}
...
.tcrn-doc-shell[data-sidebar-collapsed="true"] .tcrn-doc-brand__mark {
  width: 40px;
  height: 40px;
}
.tcrn-doc-shell[data-sidebar-collapsed="true"] .tcrn-doc-brand__copy {
  max-width: 0;
  opacity: 0;
  pointer-events: none;
  transform: translateX(-8px);
...
.tcrn-doc-shell[data-sidebar-collapsed="true"] .tcrn-doc-sidebar-toggle {
  top: 60px;
  left: calc((var(--tcrn-doc-shell-side-collapsed-width) - 32px) / 2);
  transform: none;
}
.tcrn-doc-brand__mark {
  display: block;
  width: 52px;
  height: 52px;
  background: transparent;
...
.tcrn-doc-shell[data-sidebar-motion="collapsing"] .tcrn-doc-brand__copy {
  max-width: 220px;
  opacity: 0;
  transform: translateX(-8px);
  visibility: visible;
...
.tcrn-doc-shell[data-sidebar-motion="expanding"] .tcrn-doc-brand__copy {
...
@media (max-width: 760px) {
  ...
  .tcrn-doc-header-controls__row {
    grid-template-columns: minmax(104px, 0.8fr) minmax(150px, 1fr) 36px;
  }
  .tcrn-doc-header-controls__hint {
    white-space: normal;
  }
