...
ProductShell visual oracle: ${contract.productShellVisualOracle.id}; baseline: ${contract.productShellVisualOracle.baselineManifest}#sourceHead=${contract.productShellVisualOracle.sourceHead}; oracle recovery: ${contract.productShellVisualOracle.oracleRecoveryReceipt}; baseline classification: ${contract.productShellVisualOracle.baselineManifestClassification}; search rest ${contract.productShellVisualOracle.shellMetrics.searchRestWidthPx}px; theme radius ${contract.productShellVisualOracle.shellMetrics.themeToggleRadiusPx}px
