...
// TCRN-DS-INIT-012 — the domain components' tests, moved with them.
//
// Tests that stayed behind in core would either fail to compile or, worse, keep
// passing against a re-export and give the impression core still owns these.
