...
export const localeInvariantLedger = {
  ...
  translationDebtAllowlist: {
    ...
    "foundation-visual-standards": [
      ...
      "functional display layout and density components exported by",
      ...
      "A product builds reusable record rows",
      "board cards",
      "or activity feeds locally instead of consuming admitted functional display package exports.",
    ...
    "documents-and-collaboration-components-spec": [
      "Design System",
      "Registered document surfaces",
      "Static document canvas using",
    ...
    "documents-and-collaboration-density-spec": [
      ...
      "Document surfaces accept the same comfortable",
      "or dense density. The same TreeNav is shown at all three. Only the dense modifier carries distinct package styling today",
      "comfortable and compact record the density on data",
      "density but share the default styling.",
      "Document publishing is not wired in this static DS fixture",
    ],
    "documents-and-collaboration-templates-spec": [
      "Static Design System template fixture",
      "product route owns creation",
      "Documents and collaboration examples are static DS components only",
    ...
    "table-record-index-spec": [
      "Record index scanning",
    ],
    "hierarchy-and-relations-stages-spec": [
      "and references",
      "Records and stages sample",
    ],
    "detail-and-inspection-density-spec": [
      "Functional display surfaces accept a comfortable",
      "or dense density. The same AttachmentList is shown at all three. Only the dense modifier carries distinct package styling today",
      "comfortable and compact record the density on data",
      "density but share the default styling.",
    ],
    "text-styles": [
    ...
    "records-and-boards-backlog-spec": [
      ...
      "Functional display static mockup content contract",
    ...
    "records-and-boards-components-spec": [
      "These functional display surfaces are package",
      "backed static presentation patterns for dense route layout",
      "local view movement",
      "row detail",
      "row grouping",
      "lane arrangement",
      "and reference context. They do not integrate APIs",
      "backend persistence",
      "live dispatch",
      "external queues",
      "product acceptance",
