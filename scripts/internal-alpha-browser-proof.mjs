...
const requiredStories = [
  ...
  { id: "aos-operations-cockpit-standard", group: "Patterns", storybookId: "tcrn-design-system-patterns--aos-operations-cockpit-standard" },
  { id: "aos-docs-readiness-standard", group: "Patterns", storybookId: "tcrn-design-system-patterns--aos-docs-readiness-standard" },
  { id: "aos-product-design-target-set-standard", group: "Patterns", storybookId: "tcrn-design-system-patterns--aos-product-design-target-set-standard" },
