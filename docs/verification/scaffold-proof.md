# Release Baseline Proof Receipt
...
- Vercel production commit: `57b1c417efe4c011daa538158b347075d122b72b`
- Vercel production domain: `https://tcrn-design-system-storybook.vercel.app/`
- Vercel deployment id: `null`
- Vercel environment: `null`
- Vercel target URL: `null`
- Vercel retained deployment count: 0
- Legacy deployment rollback surface removed: true
- Vercel observed at: `Selene selected-basis readback plus route-local curl URL reachability check`
